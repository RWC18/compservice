...
<h1>Անտիվիրուսի տեղադրում</h1>
<p>Պաշտպանել համակարգիչը վիրուսներից կարող է անել միայն օգտագործողը. Վաղաժամ վարաքումը կամ հնարավորինս քիչ վնասներ կրելը, կարելի է կազմակերպել միայն նորագույն անտիվիրուսների միջոցով. Սակայն եթե սխալ օգտվեք ծրագրից ապա երաշխիք չկա, որ Ձեր համակարգիչը չի վարաքվի վիրուսներով.</p>
<table border="0" width="50%" align="center"><tbody><tr>
<td><img class="i1" src="img/antivirus.png" border="0" alt="" title="" hspace="5" vspace="5"/></td>
</tr></tbody></table>
		<?php
...
<tr><td>Մասնագետի այցը տուն</td><td><span><?php echo $row['anti1']?></span></td></tr>
<tr><td>Դիագնոստիկա</td><td><span><?php echo $row['anti2']?></span></td></tr>
<tr><td>Касперский անտիվիրուսի տեղադրում</td><td><?php echo $row['anti3']?></td></tr>
<tr><td>Dr.Web անտիվիրուսի տեղադրում</td><td><?php echo $row['anti4']?></td></tr>
<tr><td>Nod32 անտիվիրուսի տեղադրում</td><td><?php echo $row['anti5']?></td></tr>
</table>
