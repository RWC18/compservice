...
<h1>Մասնագետի այցը ձեր բնակարան Երևանում և շրջակա տարածքում</h1>
<center><img src="img/courier.png"></center><BR>
Ցավոք սրտի հաճախ ամենակարևոր պահին խափանվում է համակարգչի, հեռախոսի և այլ տեխնիկայի աշխատանքը: Եվ դուք ընդհանրապես ազատ ժամանակ չունեք որպեսզի բերեք ձեր տեխնիկան մեր մոտ վերանորոգման և այնուհետ այն ետ վերցնել.<BR><BR>
Եվ հենց այդպիսի դեպքերի համար էլ մենք ունենք՝<a href="courier.php">"Զանգ մասնագետին"</a> ծառայությունը: Այս ծառայությունն ակտիվցնելուց հետո դուք մտածելու բան չունեք և կարող եք շարունակել զբաղվել ձեր գործերով: Մեր մասնսագետն ինքը կգա և կվերցնի ձեր տեխնիկան, այնուհետ այն կբերի ձեր տուն:<BR><BR>
Ինչպես է այն աշխատում?
<ol>
<li>Դուք թողնում եք Ձեր տվյալները<a href="order.php">Պատվեր</a> էջում, որից մի քանի րոպե անց մեր օպերատորները կկապվեն ձեզ հետ:</li>
<li>Մասնագետը կգա այն հասցեն, որը նշել էիք և ձեր ցանկացած ժամին:</li>
<li>Դուք փոխանցում եք տեխնիկան մասնագետին, որը պետք էր վերանորոգել:</li>
<li>Վերանորոգումից հետո, մասնագետը ետ կբերի ձեր տեխնիկան: Կցուցադրի աշխատանքը և կպատասխանի ձեր հարցերին:</li>
</ol>
Այս ծառայությունն արժէ ընդհամենը  1500 դրամ, եթե դուք ապրում եք Երևանում, իսկ եթե ապրում եք շրջակա տարածքում, ապա հարցրեք այն մեր օպերատորից <a href="contacts.php">Կոնտակտներ</a> էջի օգնությաբ: Գնի մեջ ներառված է տեխնիկայի տեղափոխումը: Վճարումը կատարվում է տեղում, կանխիկ:
