...
<h1>Էլեկտրոնիկայի և կենցաղային տեխնիկայի վերանորոգում Երևանում և շրջակա տարածքում</h1>
<p>Մեր սերվիս կենտրոնը առաջարկում է Ձեզ վերապատրաստված և փորձառու մասնագետներ, ինպես նաև օրիգինալ մասեր.</p> 
<center><img class="i1" src="img/electronics.jpg" border="0" alt="" width="80%" title="Ремонт электроники и бытовой техники в Барселоне - Компьютерный сервис в Барселоне" hspace="20"/></center>

<h2>Մեր առավելությունները:</h2>
<ul class="li">
<li>Ամենացածր գները;</li>
<li>Փորձառու մասնագետներ;</li>
<li>Վերանորոգման ամենակարճ ժամանակը;</li>
<li>Պտվիրատու տանը վերանորոգելու հնարավորություն;</li>
<li><a href="courier.php">"Զանգ մասնագետին"</a> ծառայությունը կփրկի Ձեզ դժվարություններից;</li>
<li>Անվճար դիագնոստիկա;</li>
<li>Տրվում է երաշխիք բոլոր ծառայությունների համար;</li>
<li>Մշտական հաճախորդներին տրվում է երախիքի կտրոն;</li>
</ul>
<h2>Ամենատարածված խափանված տեխնիկաները, որոնք մենք վերանորոգել ենք:</h2>
<ul class="li">
<li>Արդուկների վերանորոգում</li>
<li>Թեյնիկների վերանորոգում</li>
<li>Փոշեկուլների վերանորոգում</li>
<li>Տպիչների վերանորոգում</li>
<li>Մոնիտորների վերանորոգում</li>
<li>Վիդեոկամերաների վերանորոգում</li>
<li>Հեռուստացույցերի վերանորոգում</li>
<li>Տեսախցիկների վերանորոգում</li>
<li>Խոհանոցային տեխնիկայի վերանորոգում</li>
<li>Լվացքի մեքենաների վերանորոգում</li>
<li>Խաղային ապարատների /PlayStation 3,4, Nintendo և այլն/ վերանորոգում</li>
</ul>
