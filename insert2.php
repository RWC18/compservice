...
$sql = "INSERT INTO patver (Name, Phone, Adress, Time, Problem) VALUES ('$Name', '$Phone', '$Adress', '$Time', '$Problem')";

if (mysqli_query($conn, $sql)) {
    echo "<h1>"."Ձեր պատվերը ընդունված է: Շուտով մենք կկապվենք ձեզ հետ". "</h1>";
} else {
