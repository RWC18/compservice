...
<h1>Վիրուսների մաքրում</h1>
<p>Եթե Ձեզ թվում է, որ Ձեր համակարգիչը լի է վիրուսներով, կամ ծրագիր տեղադրելուց հետո Troyan վիրուս է տեղադրվել Ձեր համակարգչում, որը կգողանա կայքերից Ձեր բոլոր գաղտնաբառները, կրեդիտ քարտի համարները ապա դիմեք մեզ. Մեր մասնագետը կայցելի, կստուգի և կվնասազերծի վիրուսներով լի համակարգիչը.</p>
<p>Բոլոր հայտնաբերված վիրուսները կմաքրվեն ստանդարտ անտիվիրուսներով կամ ձեռքով. Երկրորդ մեթոդը գործի է դրվում այն ժամանակ, երբ անտիվիրուսները անզոր են այս ամենի դեմ. Այդպիսի փորձ ունեն մեր մասնագետները, և դուք վստահ կարող եք հավատալ մեզ.</p>
<table border="0" width="50%" align="center"><tbody><tr>
<td><img class="i1" src="img/virus1.png" border="0" alt="" title="" hspace="25" vspace="0"/></td>
<td><img class="i1" src="img/virus2.png" border="0" alt="" title="" hspace="25" vspace="0"/></td>
</tr></tbody></table>
		<?php
...
<tr><td>Մասնագետի այցը Երևանում</td><td><span><?php echo $row['Vir1'] ?> </span></td></tr>
<tr><td>Դիագնոստիկա</td><td><span><?php echo $row['Vir2'] ?></span></td></tr>
<tr><td>Վիրուսների հեռացում</td><td><?php echo $row['Vir3'] ?></td></tr>
<tr><td>SMS բաններների հեռացում</td><td><?php echo $row['Vir4'] ?></td></tr>
<tr><td>Անտիվիրուսների տեղադրում</td><td><?php echo $row['Vir5'] ?></td></tr>
</table>
