...
<li class="top-menu topmenua"><a href="work.php">Աշխատատեղ</a></li>
...
<h1>Աշխատանք Երևանում մասնագետների համար</h1>
<div align="center"><img class="i1" src="img/rabota.png" border="0" alt="" hspace="5" vspace="15"/></div>
<p>Մենք հրավիրում ենք մասնագետներին համագործակցել մեզ հետ, համակարգչային ծառայությունների ոլորտում շատ բարենպաստ պայմաններով:</p>
<p>- Եթե դուք կարողանում եք վերանորոգել համակարգիչը,  <br></p>
<p>- Եթե դուք կարողանում եք ֆորմատավորել համակարգիչը, տեղադրել ծրագրեր և դրայվերներ, <br></p>
<p>- Վերականգնել կորցրած կամ ջնջված ֆայլերը, <br></p>
<p>- Կարողանում եք կառուցել կայք, <br></p>
<p>- Կարգավորել Wi-Fi, ռոուտերներ պարամետրերը,<br></p>
<p>- Ջնջել վիրուսները և այլն, <br></p>
Ապա անպայման կապնվեք մեզ հետ հետևյալ հեռախոսահամարով՝ (+374)93 54-38-49, կամ <a href="contact.php">"Կոնտակտներ"</a> էջի օգնությամբ:</p>
<p>Կարող է պատահել, դուք չգտաք ձեր հմտությունները վերը նշված ցանկում, դիմեք մեզ ամեն դեպքում:</p>
<p>Մենք միայն ուրախ ենք համագործակցել այն մարդկանց հետ, ովքեր իրոք գիտակ մասնագետներ են:</p>
...
<li><a href="work.php">Փնտրում ենք մասնագետներ</a></li>
